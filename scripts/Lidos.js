...
let btn10 = document.querySelector("#ba10");
...
btn10.addEventListener('click', function(){
    ...
    par = document.querySelector("#aqui");
    par.innerText = d;
});  

let btexcluir = document.querySelector("#excluir");

btexcluir.addEventListener('click', function(){
    alert("Excluído, entre em vizualizar para observar a alteração") 
    inp0 = document.querySelector("#esco");
    let vel0 = inp0.value;

    nome.splice(vel0, 1);
    autor.splice(vel0, 1);
    genero.splice(vel0, 1);
    editora.splice(vel0, 1);
    nota.splice(vel0, 1);
     tempo.splice(vel0, 1);
